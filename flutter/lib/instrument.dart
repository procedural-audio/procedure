            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Expanded(
                      child: WidgetTreeMenu(widget.tree, widget.host)
                    ),
                    Expanded(
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: widget.host.globals.rootWidget != null ? WidgetTreeElement(
    ...
    return ExpansionTile(
      title: Row(
        children: [
          ...
          widget.getName() == "Empty" || widget.getName() == "Root" ? Container() : 
          IconButton(
            icon: const Icon(
              Icons.delete,
              color: Colors.white,
                ...
                children: [
                  ...
                  WidgetMenuSection(
                    ...
                    children: [
                        ...
                        WidgetMenuElement("Oscilliscope", Icons.radio_button_checked),
