...
/*class UserInterfaceEditor extends StatefulWidget {
  UserInterfaceEditor(this.ui) {
    // tree = UITree(app);
  }
  ...
  @override
  State<UserInterfaceEditor> createState() => _UserInterfaceEditor();
}

class _UserInterfaceEditor extends State<UserInterfaceEditor> {
  // late Widget display;
...
class _UIDisplay extends State<UIDisplay> {
  ...
  @override
  Widget build(BuildContext context) {
    widget.app.project.value.ui.value ??=
        UserInterface(widget.app, widget.tree);
