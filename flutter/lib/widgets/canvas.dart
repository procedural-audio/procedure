...
bool Function(FFIWidgetPointer) ffiPainterShouldPaint = core
    .lookup<NativeFunction<Bool Function(FFIWidgetPointer)>>(
        "ffi_painter_should_paint")
    .asFunction();
void Function(FFIWidgetPointer, Pointer<CanvasFFI>) ffiPainterPaint = core
    .lookup<
        NativeFunction<
            Void Function(
                FFIWidgetPointer, Pointer<CanvasFFI>)>>("ffi_painter_paint")
    .asFunction();
...
class CanvasWidget extends ModuleWidget {
  CanvasWidget(Host h, FFINode m, FFIWidget w) : super(h, m, w) {
    print("WILL LEAK THE CANVAS BELOW");
  }
  ...
  Widget build(BuildContext context) {
    return CustomPaint(painter: CanvasPainter(widgetRaw, canvasRaw));
  }
}
...
class CanvasPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, ui.Size size) {
    ffiPainterPaint(widgetRaw.pointer, canvasRaw);
