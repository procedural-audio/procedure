...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1672904895;
...
fn wire__crate__api__graph__Graph_from_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            let api_cables = <Vec<crate::api::cable::Cable>>::sse_decode(&mut deserializer);
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::graph::Graph::from(api_nodes, api_cables))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__api__node__Node_from_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::node::Node::from(&api_source))?;
                Ok(output_ok)
            })())
        },
    )
...
impl SseDecode for Vec<crate::api::cable::Cable> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
        for idx_ in 0..len_ {
            ans_.push(<crate::api::cable::Cable>::sse_decode(deserializer));
        }
        return ans_;
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__graph__Graph_from_impl(ptr, rust_vec_len, data_len),
        5 => wire__crate__api__graph__Graph_new_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__graph__clear_patch_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__graph__set_patch_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__node__Node_auto_accessor_get_id_impl(ptr, rust_vec_len, data_len),
        9 => wire__crate__api__node__Node_auto_accessor_set_id_impl(ptr, rust_vec_len, data_len),
        10 => wire__crate__api__node__Node_from_impl(ptr, rust_vec_len, data_len),
        11 => wire__crate__api__node__Node_get_inputs_impl(ptr, rust_vec_len, data_len),
        12 => wire__crate__api__node__Node_get_outputs_impl(ptr, rust_vec_len, data_len),
        13 => wire__crate__api__node__Node_set_parameter_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl SseEncode for Vec<crate::api::cable::Cable> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::api::cable::Cable>::sse_encode(item, serializer);
        }
    }
}
